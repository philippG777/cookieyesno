(function () {
    ...
    */
    ...
    function showCookieSettings(cyn) {
        var settings = JSON.stringify(cyn._load(), null, 2);
    ...
    // buttons
    document.getElementById('reviewbutton').onclick = function () { return cyn.reviewSettings(); };
